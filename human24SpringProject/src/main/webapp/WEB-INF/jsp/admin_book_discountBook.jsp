...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/admin_book_discountBook.css"> 
</head>
        ...
        <div id="wrapping">
            <div id="subMenu">
                <ul>
                    ...
                    <li class="subOn" onclick="window.location.href='/main/admin/book/discountBook'">할인 책 관리</li>
                        ...
                        <table id="listTbl">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>10%</td>
                                    <td>N</td>
                                    <td><input type="button" value="할인적용해제" class="btn2 goDetail"></td>
                                </tr>
                                <tr>
                                    <td>A1_1</td>
                                    <td>컴퓨터</td>
